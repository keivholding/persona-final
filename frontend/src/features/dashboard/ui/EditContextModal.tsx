...
interface EditContextModalProps {
  isOpen: boolean;
  onClose: () => void;
  onSubmit: (contextId: string, updates: CreateContextRequest) => Promise<Context>;
...
const EditContextModal = ({ isOpen, onClose, onSubmit, context }: EditContextModalProps) => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      await onSubmit(context.id, formData);
      onClose();
    } catch (err) {
