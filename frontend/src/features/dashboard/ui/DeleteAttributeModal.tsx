...
const DeleteAttributeModal = ({ isOpen, onClose, onConfirm, attribute }: DeleteAttributeModalProps) => {
                  ...
                  <div className="mt-4 p-3 bg-amber-50 border border-amber-200 rounded-lg">
                    <div className="flex items-center gap-2">
                      ...
                      <p className="text-amber-700 text-sm font-medium">
                        This will permanently remove this attribute from all contexts.
                      </p>
                    </div>
                  </div>
                </div>
